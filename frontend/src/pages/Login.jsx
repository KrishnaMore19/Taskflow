// src/pages/Login.jsx — Fully Responsive
    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#FAFAF7", color: "#0A0A0A", display: "flex", flexDirection: "column" }}>
      ...
      <main className="auth-main" style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div className="auth-box">
          <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "0.65rem", letterSpacing: "0.3em", textTransform: "uppercase", color: "#E84025", marginBottom: "1.5rem" }}>
            — Sign in
          </div>
          <h1 className="auth-h1" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "3rem", fontWeight: 900, lineHeight: 0.95, letterSpacing: "-0.03em", marginBottom: "0.75rem" }}>
            Welcome<br /><em style={{ fontStyle: "italic", color: "#E84025" }}>back.</em>
          </h1>
          ...
          {error && (
            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", padding: "0.85rem 1rem", border: "1.5px solid #E84025", background: "rgba(232,64,37,0.04)", marginBottom: "1.5rem" }}>
              ...
              <span style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.8rem", color: "#E84025" }}>{error}</span>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
            <div>
              ...
              <input type="email" name="email" value={formData.email} onChange={handleChange} required autoComplete="email" placeholder="you@example.com" className="tf-input" />
            </div>
            <div>
              ...
              <div style={{ position: "relative" }}>
                <input type={showPassword ? "text" : "password"} name="password" value={formData.password} onChange={handleChange} required autoComplete="current-password" placeholder="Your password" className="tf-input" style={{ paddingRight: "3rem" }} />
          ...
          <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.8rem", color: "#5A5A5A", marginTop: "2rem", textAlign: "center" }}>
            No account?{" "}
            <Link to="/signup" style={{ color: "#E84025", fontWeight: 600, textDecoration: "none" }}>Create one free →</Link>
          </p>
        </div>
      </main>
